...
class App extends Component {
  ...
  handleButton = (event) => {
    const arrayOutput = this.state.output.concat(event.target.value);
    this.setState({
      output: arrayOutput,
    })
  }
    ...
    return (
      <div className="App">
        ...
        <div className="inputs">
          ...
          <br/>
          <button id="nine" className="btn btn-secondary" value="9" onClick={this.handleButton}>9</button>
          <button id="eight" className="btn btn-secondary" value="8" onClick={this.handleButton}>8</button>
          <button id="seven" className="btn btn-secondary" value="7" onClick={this.handleButton}>7</button>
          <button id="multiply" className="btn btn-light" value="*" onClick={this.handleButton}>*</button>
          <br/>
          <button id="six" className="btn btn-secondary" value="6" onClick={this.handleButton}>6</button>
          <button id="five" className="btn btn-secondary" value="5" onClick={this.handleButton}>5</button>
          <button id="four" className="btn btn-secondary" value="4" onClick={this.handleButton}>4</button>
          <button id="subtract" className="btn btn-light" value="-" onClick={this.handleButton}>-</button>
          <br/>
          <button id="three" className="btn btn-secondary" value="3" onClick={this.handleButton}>3</button>
          <button id="two" className="btn btn-secondary" value="2" onClick={this.handleButton}>2</button>
          <button id="one" className="btn btn-secondary" value="1" onClick={this.handleButton}>1</button>
          <button id="add" className="btn btn-light" value="+" onClick={this.handleButton}>+</button>
          <br/>
